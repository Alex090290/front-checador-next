...
import FormUpdateDatest2 from "@/components/inability/FormUpdateDatest2";
...
function ST2Card({
  ...
  st2Doc: IInability["sT2DischargeDocument"] | undefined;
  idDoc: string;
    ...
    <>
        ...
        <Card className="rounded shadow-sm bg-body-tertiary h-100">
          ...
          <Card.Footer>
            ...
            <p className="text-center">
              {formatCreatedAt(st2Doc?.expirationDateDocument) || "Sin fecha de expiración"}
            </p>
          </Card.Footer>
        </Card>
      ...
      <ConditionalRender cond={showUpdateDateModal}>
        <ModalBlur onClose={() => setShowUpdateDateModal(false)}>
          <FormUpdateDatest2
            key={st2Doc?.expirationDateDocument}
