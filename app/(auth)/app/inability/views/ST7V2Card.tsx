...
import FormUpdateDatev2 from "@/components/inability/FormUpdateDatev2";
...
function ST7V2Card({
  ...
  st2v2Doc: IInability["sT7FillingDocumentv2"] | undefined;
  idDoc: string;
  ...
  const hasDocument = !!st2v2Doc?.urlDocument;
    ...
    <>
        ...
        <Card className="rounded shadow-sm bg-body-tertiary h-100">
          ...
          <Card.Footer>
            ...
            <p className="text-center">
              {formatCreatedAt(st2v2Doc?.expirationDateDocument) || "Sin fecha de expiración"}
            </p>
          </Card.Footer>
        </Card>
        <PDFViewerModal
      ...
      <ConditionalRender cond={showUpdateDateModal}>
        <ModalBlur onClose={() => setShowUpdateDateModal(false)}>
          <FormUpdateDatev2
            key={st2v2Doc?.expirationDateDocument}
