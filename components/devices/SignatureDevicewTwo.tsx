...
function SignatureDevicewTwo({
    ...
    useEffect(() => {
        const handleFetchSignature = async () => {
            ...
            try {
                ...
                const res = await fetchSignatureDevice({
                    idDevice: idDevice,
    ...
    }, [idDevice, idSignature, idEmployee]);
    ...
    const getBadge = () => {
        ...
        if (normalizedLabel === "IT - Entregado") {
...
export default SignatureDevicewTwo;
