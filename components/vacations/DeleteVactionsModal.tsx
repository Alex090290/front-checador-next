...
import { deleteVacations } from "@/app/actions/vacations-actions";
  ...
  export default function DeleteVacationModal({
      ...
      const onSubmit: SubmitHandler<IDeleteIncidenece> = async (data) => {
          ...
          modalConfirm("¿Seguro que quieres eliminar esta solicitud de vacación?", async () => {
  
              try {
                  setFeedback("loading");
                  setFeedbackMsg("Eliminando solicitud...");
  
                  const res = await deleteVacations({
                      id: idVacation,
                      idPeriod: idPeriod,
                      data: data,
                  });
                  ...
                  setFeedbackMsg(res.message || "Eliminada correctamente");
                  setFeedback("success");
                  ...
                  <Container className="mt-4">
                      <div className="p-2">
                          <div className="d-flex justify-content-between align-items-center mb-2 flex-wrap gap-3">
                              <h4 className="mb-0 fw-bold">Eliminar Solicitud de Vacaciones</h4>
