              ...
              <Card className="border-0 table-active">
                <Card.Body className="py-2 px-3">
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="text-muted small text-uppercase">Periodo Vacacional</div>
                    ...
                    <Col xs={12} md={6}>
                      <Card className="border-0 table-active h-100">
                        <Card.Body className="py-3 px-3">
                          ...
                          {/* <div className="text-muted small mt-1">
                            ID: {vacation.createForPerson?.id ?? "—"}
                          </div> */}
                        </Card.Body>
                      </Card>
                    </Col>
                    ...
                    <Table responsive hover borderless className="m-0">
                      <thead className="text-uppercase">
                        <tr>
                          ...
                          <th className="text-muted small text-end">Periodo catorcenal</th>
                        </tr>
                      </thead>
                      <tbody>
                        {daysList.map((d: any) => (
