...
type ModalAction = {
    idInhability: number | null;
    motive: string | null;
    status: boolean | null;
}

export default function DeleteInhabilityModal({
    onHide,
    idInhability,
    motive,
    status
    ...
    const onSubmit: SubmitHandler<IDeleteInhability> = async (data) => {
        ...
        modalConfirm("¿Seguro que quieres eliminar esta incapacidad?", async () => {

            try {
                setFeedback("loading");
                setFeedbackMsg("Eliminando incapacidad...");

                const res = await deleteInability({
                    id: idInhability,
                    data: data,
                });
                ...
                <Container className="mt-4">
                    <div className="p-2">
                        <div className="d-flex justify-content-between align-items-center mb-2 flex-wrap gap-3">
                            <h4 className="mb-0 fw-bold">Eliminar Incapacidad</h4>
                        ...
                        <p className="text-muted">Registra la razón  por la cual se elimina la incapacidad</p>
                        ...
                        <Form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="d-flex justify-content-end gap-2 mt-4">
                                ...
                                <Button
                                    ...
                                    type="submit"
                                >
                                    {feedback === "loading" ? "Eliminando incapacidad..." : "Eliminar incapacidad"}
                                </Button>
                            </div>
                        </Form>
                    </div>
