...
import { deletePenalty } from "@/app/actions/penalties-actions";
...
export default function DeletePenaltyModal({
    ...
    const onSubmit: SubmitHandler<IDeleteIncidenece> = async (data) => {
        ...
        modalConfirm("¿Seguro que quieres eliminar esta penalización?", async () => {

            try {
                setFeedback("loading");
                setFeedbackMsg("Eliminando penalización...");
                ...
                <Container className="mt-4">
                    <div className="p-2">
                        <div className="d-flex justify-content-between align-items-center mb-2 flex-wrap gap-3">
                            <h4 className="mb-0 fw-bold">Eliminar Penalización</h4>
                        ...
                        <p className="text-muted">Registra la razón  por la cual se elimina la penalización</p>
                        ...
                        <Form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="d-flex justify-content-end gap-2 mt-4">
                                ...
                                <Button
                                    ...
                                    type="submit"
                                >
                                    {feedback === "loading" ? "Eliminando penalización..." : "Eliminar penalización"}
                                </Button>
                            </div>
                        </Form>
                    </div>
