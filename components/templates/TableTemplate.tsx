...
function TableTemplateInner<T>(
  { columns, data, getRowId, onSelectionChange, viewForm }: TableProps<T>,
...
const TableTemplate = forwardRef(TableTemplateInner) as <T>(
  props: TableProps<T> & { ref?: React.Ref<TableTemplateRef> }
) => ReturnType<typeof TableTemplateInner>;
